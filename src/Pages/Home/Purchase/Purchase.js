            ...
            <div className="hero min-h-screen">
                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className="text-center lg:text-left sm:w-full lg:w-1/2">
                        ...
                        <h1 className='text-3xl font-mono font-bold'>{booking.name}</h1>
                        <p className='text-accent font-bold'>Details</p>
                        <p className='text-gray-500'>{booking.description}</p>
                        <p className='text-accent text-2xl font-bold'>Price :  <span className=''>{booking.price}$</span></p>
                        <p className='text-accent text-2xl font-bold uppercase'>Available :  <span className='text-gray-500'>{booking.available} products</span></p>
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="form-control mt-6">
                                    <button disabled={errors.amount?.type === 'min' || errors.amount?.type === 'max'} className="btn btn-primary">Purchase your product</button>
                                </div>
